...
export interface KeepersCounterEchidnaTest extends BaseContract {
  ...
  callStatic: {
    ...
    performUpkeep(arg0: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>
  }
  ...
  estimateGas: {
    ...
    echidna_test_perform_upkeep_gate(overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    echidna_test_perform_upkeep_gate(overrides?: CallOverrides): Promise<PopulatedTransaction>
